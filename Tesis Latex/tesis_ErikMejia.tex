...
\usepackage{titlesec}
\usepackage{amsmath}
\usepackage[margin=1.5cm]{graphicx,caption}
...
\advisortitle{Dr.} \advisorname{Jos\'e de J\'esus Villa Hern\'andez}
...
\include{Cap4_Resultados} % incluye al archivo Ecuaciones.tex
\include{Cap5_Conclusiones}            % incluye al archivo Conclusiones.tex
