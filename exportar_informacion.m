...
%     end
    ...
    finalCell = [num2cell(roundness') num2cell(cellExcentricity)]; %Combinamos las celdas de excentricidad y clasificaciones
    tableExcen = cell2table(finalCell);
    writetable(tableExcen,excelname,'Sheet',1,'Range','A1')
%end
